class classes.Toys.BeachBall extends classes.Toys.Toys
{
   ...
   function initVars()
   {
      ...
      this.toyClip = _global.gCanvas.clipping_canvas.beachBallHolder;
   ...
   function initEvent()
   {
      ...
      if(!this.toyClip["ball" + _loc3_] && _loc3_ != undefined && _loc3_ != "undefined")
      {
         ...
         var _loc4_ = this.toyClip.attachMovie("beachBall_mc","ball" + _loc3_,this.toyClip.getNextHighestDepth());
         ...
         var _loc6_ = [_loc4_._x,_loc4_._y,_loc4_._x,_loc4_._y,null,"beachBall",_loc3_,_loc4_.ballId];
      ...
      else
      {
         ...
         _loc6_ = [_loc5_._x,_loc5_._y,_loc5_._x,_loc5_._y,null,"beachBall",_loc3_,_loc3_];
         this.GSC_REF.broadcastAvatarToy(_loc6_);
      }
   }
   ...
   function startBallEvent(avId)
   {
      ...
      this.toyClip["ball" + avId].onEnterFrame = function()
      {
         if(this.ball.hotspot.hitTest(this.thisClass.myAv.avatarContainer.image.avParts.dropShadow))
         {
            ...
            _loc8_ = [_loc3_.lastX,_loc3_.lastY,this.thisClass.toyClip["ball" + this.ballId]._x + _loc7_,this.thisClass.toyClip["ball" + this.ballId]._y + 10 + _loc6_,null,"beachBall",_loc4_,this.ballId];
   ...
   function displayEvent(startX, startY, xTarget, yTarget, targetClip, memberId, ballId)
   {
      ...
      if(!this.toyClip["ball" + ballId] && ballId != "undefined" && ballId != undefined)
      {
         ...
         var _loc3_ = this.toyClip.attachMovie("beachBall_mc","ball" + ballId,this.toyClip.getNextHighestDepth());

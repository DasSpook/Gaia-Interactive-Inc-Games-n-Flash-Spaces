package com.gaiaonline.containers
{
   ...
   public class LegacyZomgGameWindow extends UIComponent implements ISettings
   {
      
      private static var s_filters:Array = [new DropShadowFilter(8,45,0,1,6,6,0.5,1,false,false,false)];
      ...
      protected var legacyMinHeight:uint = 20;
      ...
      protected var legacyMinWidth:uint = 20;
      ...
      protected var legacyMaxWidth:uint = 0;
      ...
      protected var legacyMaxHeight:uint = 0;
      ...
      public function LegacyZomgGameWindow(swfWin:String, container:DisplayObject, isDragable:Boolean = true, isResisable:Boolean = true, showClose:Boolean = true, showMax:Boolean = true, legacyMaxWidth:uint = 0, legacyMaxHeight:uint = 0, legacyMinWidth:uint = 0, legacyMinHeight:uint = 0, minized:Boolean = false, maximized:Boolean = false, loaderContextFactory:ILoaderContextFactory = null)
      {
         ...
         this.legacyMaxHeight = legacyMaxHeight;
         this.legacyMinWidth = legacyMinWidth;
         this.legacyMinHeight = legacyMinHeight;
         this.winLoader = new Loader();
         if(minized)
         {
            this.winWidth = this.legacyMinWidth;
            this.winHeight = this.legacyMinHeight;
         }
         if(maximized)
         {
            this.winWidth = this.legacyMaxWidth;
            this.winHeight = this.legacyMaxHeight;
            this.isMax = true;
            this.resetWidth = this.legacyMinWidth;
            this.resetHeight = this.legacyMinHeight;
         }
      ...
      {
         return this.legacyMaxHeight;
      }
      
      public function setMaxHeight(v:uint) : void
      {
         this.legacyMaxHeight = v;
         if(this.isMax)
         {
            this.setSize(this.stage.stageWidth,this.stage.stageHeight);
         }
      ...
      public function setSize(width:uint, height:uint) : void
      {
         if(this.stage != null)
         {
            if(this.legacyMaxWidth > 0 && width > this.legacyMaxWidth)
            {
               this.winWidth = legacyMaxWidth;
            }
            else if(this.legacyMinWidth > 0 && width < this.legacyMinWidth)
            {
               this.winWidth = this.legacyMinWidth;
            }
            else
            ...
            if(this.legacyMaxHeight > 0 && height > this.legacyMaxHeight)
            {
               this.winHeight = legacyMaxHeight;
            }
            else if(this.legacyMinHeight > 0 && width < this.legacyMinHeight)
            {
               this.winHeight = this.legacyMinHeight;
            }
            else
      ...
      public function getSettings() : Object
      {
         ...
         obj.minWidth = this.legacyMinWidth;
         obj.minHeight = this.legacyMinHeight;
         obj.maxWidth = this.legacyMaxWidth;
         obj.maxHeight = this.legacyMaxHeight;
      ...
      public function setSettings(obj:Object) : void
      {
         ...
         this.legacyMinWidth = obj.minWidth;
         this.legacyMinHeight = obj.minHeight;
         this.legacyMaxWidth = obj.maxWidth;
         this.legacyMaxHeight = obj.maxHeight;
      ...
      private function onIOError(e:IOErrorEvent) : void
      {
         ...
         trace("[LegacyZomgWindow.as onIOError] :",e.text);
         this.retryLoad();
      }
      ...
      protected function onResizeButtonMove(evt:MouseEvent) : void
      {
         ...
         if(nw < this.legacyMinWidth)
         {
            nw = this.legacyMinWidth;
         }
         ...
         if(nh < this.legacyMinHeight)
         {
            nh = this.legacyMinHeight;
         }
         this.isMax = false;
         this.setSize(nw,nh);
      }

package com.gaiaonline.battle.moduleManagers
{
   ...
   import com.gaiaonline.battle.ui.actorInfo.ActorInfoController;
   ...
   public final class ActorInfoModuleManager implements IModuleManager, IAsyncCreationHandler
   {
       
      
      private var _path:String = null;
      
      private var _controller:ActorInfoController = null;
      ...
      public function ActorInfoModuleManager()
      {
         super();
      }
      ...
      private function getModule() : void
      {
         if(!_pending)
         {
            this._controller = new ActorInfoController(this._flexUIManager);
            if(this._mostRecentlySelectedActorRef)
            {
               this._controller.setActorInfo(BaseActor(this._mostRecentlySelectedActorRef.get()));
            }
      ...
      public function onCreation(instance:Object, modulePath:String) : void
      {
         ...
         this._windowManager.add(_window,new GameWindowSettings(_title).setPos(10,10));
         this._controller.addView(this._instance as IActorInfo);
         this.open(null);
         _pending = false;
      }

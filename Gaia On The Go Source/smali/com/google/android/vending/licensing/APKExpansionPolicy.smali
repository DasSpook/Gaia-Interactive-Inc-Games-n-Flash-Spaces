...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/vending/licensing/Obfuscator;)V
    ...
    iput-wide v1, p0, Lcom/google/android/vending/licensing/APKExpansionPolicy;->mLastResponseTime:J
...
.method private decodeExtras(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 382
    .local v6, "rawExtras":Ljava/net/URI;
    const-string v8, "UTF-8"

    invoke-static {v6, v8}, Lorg/apache/http/client/utils/URLEncodedUtils;->parse(Ljava/net/URI;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 384
    .local v4, "item":Lorg/apache/http/NameValuePair;
    ...
    .end local v4    # "item":Lorg/apache/http/NameValuePair;
    .end local v5    # "name":Ljava/lang/String;
    .end local v6    # "rawExtras":Ljava/net/URI;
    :catch_0
    move-exception v0

    .line 392
    .local v0, "e":Ljava/net/URISyntaxException;
    const-string v8, "APKExpansionPolicy"

    const-string v9, "Invalid syntax error while decoding extras data from server."
...
.method public processServerResponse(ILcom/google/android/vending/licensing/ResponseData;)V
    ...
    invoke-direct {p0, v5, v6}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->setRetryCount(J)V
    ...
    .line 141
    iget-object v5, p2, Lcom/google/android/vending/licensing/ResponseData;->extra:Ljava/lang/String;

    invoke-direct {p0, v5}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->decodeExtras(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-direct {p0, v5}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->setValidityTimestamp(Ljava/lang/String;)V
    ...
    :cond_1
    iget-wide v5, p0, Lcom/google/android/vending/licensing/APKExpansionPolicy;->mRetryCount:J
    ...
    invoke-direct {p0, v5}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->setRetryUntil(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->setMaxRetries(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v5}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->setExpansionURL(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v5}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->setExpansionFileName(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v5, v6}, Lcom/google/android/vending/licensing/APKExpansionPolicy;->setExpansionFileSize(IJ)V
    ...
    .line 171
    iget-object v5, p0, Lcom/google/android/vending/licensing/APKExpansionPolicy;->mPreferences:Lcom/google/android/vending/licensing/PreferenceObfuscator;

    invoke-virtual {v5}, Lcom/google/android/vending/licensing/PreferenceObfuscator;->commit()V
